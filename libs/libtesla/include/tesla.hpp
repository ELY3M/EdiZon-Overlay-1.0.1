...
namespace tsl {
    ...
    namespace cfg {
        ...
        constexpr u32 ScreenWidth = 1280; //was 1920;       ///< Width of the Screen
        constexpr u32 ScreenHeight = 1080; //was 1080;      ///< Height of the Screen
    ...
    namespace gfx {
        ...
        private:
            ...
            void init() {
                ...
                cfg::LayerPosX = 0;
                cfg::LayerPosY = 0;
                cfg::FramebufferWidth  = 448; //might try 405 to avoid crashes//  
                cfg::FramebufferHeight = 667; //was 720
