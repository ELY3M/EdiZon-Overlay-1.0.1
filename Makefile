...
CFLAGS	+=	$(INCLUDE) -D__SWITCH__ -D__OVERLAY__ -DAPP_TITLE="\"$(APP_TITLE)\"" -DAPP_VERSION="\"$(APP_VERSION)\"" -I$(PORTLIBS)/include/freetype2 $(pkg-config --cflags --libs python3) -Wno-deprecated-declarations
